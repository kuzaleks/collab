...
expected_results = [
    ({
        ...
        '-52': ['0', '1', '-58'],
        '33': ['1', '0', '43'],
    }, 'examples_of_labs/1_6/1_6__1.cpp'),
    ({
        '0': ['0', '0', '20'],
        '1': ['1', '0', '21'],
        '-1': ['1', '1', '235'],
        ...
        '255': ['1', '1', '235'],
        '196': ['0', '1', '208'],
    }, 'examples_of_labs/1_6/1_6__2.cpp'),
    ({
        '0': ['0', '0', '0', '72'],
        '1': ['1', '0', '0', '73'],
        '-1': ['1', '1', '1', '-73'],
        ...
        '62': ['0', '1', '0', '118'],
        '41': ['1', '1', '0', '97'],
    }, 'examples_of_labs/1_6/1_6__3.cpp'),
    ({
        '0': ['0', '0', '0', '130'],
        '1': ['1', '0', '0', '131'],
        '-1': ['1', '1', '1', '-131'],
        ...
        '30223': ['1', '1', '1', '30349'],
        '-6847': ['1', '0', '1', '-6717'],
    }, 'examples_of_labs/1_6/1_6__4.cpp'),
    ({
        '0': ['0', '0', '0', '384'],
        '1': ['1', '0', '0', '385'],
        '-1': ['1', '1', '1', '65151'],
        ...
        '21845': ['1', '0', '0', '21717'],
        '65535': ['1', '1', '1', '65151'],
    }, 'examples_of_labs/1_6/1_6__5.cpp'),
    ({
        '0': ['0', '0', '0', '-32766'],
        '1': ['1', '0', '0', '-32765'],
        '-1': ['1', '1', '1', '32765'],
        ...
        '26964': ['0', '1', '0', '-5802'],
        '-6847': ['1', '0', '1', '25923'],
    }, 'examples_of_labs/1_6/1_6__6.cpp'),
    ({
        '0': ['0', '0', '0', '32896'],
        '1': ['1', '0', '0', '32897'],
        '-1': ['1', '1', '1', '-32897'],
    ...
    }, 'examples_of_labs/1_6/1_6__7.cpp'),
    ({
        '0': ['0', '0', '32896'],
        '1': ['1', '0', '32897'],
        '-1': ['1', '1', '4294934399'],
        ...
        '594560': ['0', '0', '627200'],
        '8152429': ['1', '0', '8185325'],
    }, 'examples_of_labs/1_6/1_6__8.cpp'),
    ({
        '0': ['0', '0', '0', '130'],
        '1': ['1', '0', '0', '131'],
        '-1': ['1', '1', '1', '-131'],
    ...
    }, 'examples_of_labs/1_6/1_6__9.cpp'),
    ({
        '0': ['0', '0', '0', '1026'],
        '1': ['1', '0', '0', '1027'],
    ...
    }, 'examples_of_labs/1_6/1_6__10.cpp'),
    ({
        '0': ['0', '0', '0', '3'],
        '1': ['1', '0', '0', '2'],
        '-1': ['1', '1', '1', '-4'],
    ...
    }, 'examples_of_labs/1_6/1_6__11.cpp'),
    ({
        '0': ['0', '0', '0', '32770'],
        '1': ['1', '0', '0', '32771'],
        '-1': ['1', '1', '1', '-32771'],
    ...
    }, 'examples_of_labs/1_6/1_6__12.cpp'),
]
